...
class PIECES:
    ...
    GRAVEYARD_POSITIONS = {
        ...
        0x13: (-0.5 * _S - _S // 2, 1.5 * _S - _S // 2, 270),
        0x14: (-1 * _S - _S // 2, 2 * _S - _S // 2, 270),
        0x15: (-0.5 * _S - _S // 2, 2.5 * _S - _S // 2, 270),
        0x16: (-1 * _S - _S // 2, 3 * _S - _S // 2, 270),
        0x17: (-0.5 * _S - _S // 2, 3.5 * _S - _S // 2, 270),
        0x18: (-1 * _S - _S // 2, 4 * _S - _S // 2, 270),
        0x19: (-0.5 * _S - _S // 2, 4.5 * _S - _S // 2, 270),
        # Black back rank  (IDs 0x1A–0x21)
        0x1A: (-1 * _S - _S // 2, 5 * _S - _S // 2, 270),  # Rook a8
        0x1B: (-0.5 * _S - _S // 2, 5.5 * _S - _S // 2, 270),  # Knight b8
        0x1C: (-1 * _S - _S // 2, 6 * _S - _S // 2, 270),  # Bishop c8
        0x1D: (-0.5 * _S - _S // 2, 6.5 * _S - _S // 2, 270),  # Queen d8
        0x1E: (-1 * _S - _S // 2, 7 * _S - _S // 2, 270),  # King e8
        0x1F: (-0.5 * _S - _S // 2, 7.5 * _S - _S // 2, 270),  # Bishop f8
