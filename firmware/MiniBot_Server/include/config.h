...
#define JOYSTICK_STEERING_SCALE                                                \
  0.8 // sets upper limit for steering velocity as a fraction of max velocity
...
#define JOYSTICK_WATCHDOG_INTERVAL_MS                                          \
  900 // Ensure the watchdog isn't tripped (1s timeout)
